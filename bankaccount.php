                                            ...
                                            <table class="table table-responsive-sm mb-0" id="datat">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><strong>HIỂN THỊ GỬI</strong></th>
                                                        <th><strong>HIỂN THỊ THU</strong></th>
                                                        <th><strong>THỨ TỰ TRONG BÁO CÁO</strong></th>
                                    ...
                                    <form method="POST" id="card" onsubmit="return false" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="n2" name="account" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Ghi chú</label>
