...
$items = $db->readdb("SELECT * FROM `deposits`");
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-header border-0 pb-0" style="display: flex;flex-direction: column;">
                                       <div class="top">
                                           <h4 class="card-title">Danh sách chuyển khoản đơn hàng</h4>
                                           <div>
                                                  ...
                                                  $count = 0;
                                                    foreach($items as $item) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?=$item['amount']?></td>
                                                            <td><?=$item['note']?></td>
                                                            <td> <a onclick="return delet(<?=$item['id']?>)" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a></td>
                                                        </tr>
<?php
                                                    } 
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="card" onsubmit="return false" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" id="f1" class="btn btn-success" style="float: right; margin-bottom: 10px;">Xác nhận</button>
                                    </form>
                                </div>
                                <div class="table-responsive">
