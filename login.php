                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="auth-form" style=" background-color: #1E2746 !important;box-shadow: none !important;border: 1px solid #4e5364; ">
                                    <h4 class="text-center mb-4" style="color: whitesmoke;">Đăng nhập quản lý</h4>
                                    ...
                                    <form onsubmit="return false" id="frm" method="post">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-success btn-block btn-r">Đăng nhập</button>
                                        </div>
                                    </form>
                                    <div class="new-account mt-3 flex justify-between items-center" >
